...
\author{	Nicolas Cisco, \textit{Padrón Nro. 94.XXX}                     \\
            \texttt{ ncis20@gmail.com }                                              \\
            Rodrigo Burdet, \textit{Padrón Nro. 93.440}                     \\
            \texttt{ rodrigoburdet@gmail.com }                                              \\
	    Nicolas Calvo, \textit{Padrón Nro. 00.000}                     \\
            \texttt{ dirección de e-mail }                                              \\[2.5ex]
            \normalsize{Grupo Nro. QUEGRUPOSOMOS? - 2do. Cuatrimestre de 2013}                       \\
